...
local BG_COLOR      = 1       -- background layer color    (0-15)
local CIRCLE_COLOR  = 8       -- circle palette index       (try: 8=red, 11=green, 12=blue)
...
local RECT_X        = 30      -- rectangle top-left X       (0-128)
