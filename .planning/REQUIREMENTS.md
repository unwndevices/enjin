...
- [x] **DOC-02**: All public APIs are documented with Doxygen comments (complete coverage) — partial per audit 2026-02-23
...
- [x] **DOC-04**: Module overviews added for each module (Core, Graphics, UI, Utils, etc.) explaining purpose and usage — partial per audit 2026-02-23
